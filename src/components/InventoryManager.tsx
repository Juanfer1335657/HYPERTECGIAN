                ...
                products.map((p) => (
                  <tr key={p.id} className="hover:bg-white/[0.02] transition-colors group">
                    <td className="py-6 px-8">
                      <div className="flex items-center gap-5">
                        <div className="relative w-14 h-14 rounded-[1.2rem] overflow-hidden border border-white/10 p-1 bg-white/5 group-hover:border-blue-500/30 transition-colors">
                          <img src={p.image} alt={p.title} loading="lazy" className="w-full h-full object-contain rounded-[0.9rem]" />
                        </div>
                        <div className="space-y-1">
                    ...
                    <td className="py-6 px-8 text-right">
                      <div className="flex items-center justify-end gap-3 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all duration-300 translate-x-0 md:translate-x-4 md:group-hover:translate-x-0">
                        <Link 
